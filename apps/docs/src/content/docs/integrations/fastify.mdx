...
<CodeBlockTabs defaultValue="pnpm" groupId="package-manager">
    ...
    <CodeBlockTab value="npm">
        ```bash npm install @ratelock/fastify @ratelock/redis ```
    </CodeBlockTab>
    <CodeBlockTab value="pnpm">```bash pnpm add @ratelock/fastify @ratelock/redis ```</CodeBlockTab>
    <CodeBlockTab value="yarn">```bash yarn add @ratelock/fastify @ratelock/redis ```</CodeBlockTab>
    <CodeBlockTab value="bun">```bash bun add @ratelock/fastify @ratelock/redis ```</CodeBlockTab>
</CodeBlockTabs>
