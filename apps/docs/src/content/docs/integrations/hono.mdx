...
<CodeBlockTabs defaultValue="pnpm" groupId="package-manager">
    ...
    <CodeBlockTab value="npm">```bash npm install @ratelock/hono @ratelock/redis ```</CodeBlockTab>
    <CodeBlockTab value="pnpm">```bash pnpm add @ratelock/hono @ratelock/redis ```</CodeBlockTab>
    <CodeBlockTab value="yarn">```bash yarn add @ratelock/hono @ratelock/redis ```</CodeBlockTab>
    <CodeBlockTab value="bun">```bash bun add @ratelock/hono @ratelock/redis ```</CodeBlockTab>
</CodeBlockTabs>
