...
<CodeBlockTabs defaultValue="pnpm" groupId="package-manager">
    ...
    <CodeBlockTab value="npm">
        ```bash npm install @ratelock/express @ratelock/redis ```
    </CodeBlockTab>
    <CodeBlockTab value="pnpm">```bash pnpm add @ratelock/express @ratelock/redis ```</CodeBlockTab>
    <CodeBlockTab value="yarn">```bash yarn add @ratelock/express @ratelock/redis ```</CodeBlockTab>
    <CodeBlockTab value="bun">```bash bun add @ratelock/express @ratelock/redis ```</CodeBlockTab>
</CodeBlockTabs>
