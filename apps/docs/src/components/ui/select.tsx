...
function SelectTrigger({
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            className={cn(
                `
                  flex w-fit items-center justify-between gap-1.5 rounded-3xl
                ...
                <SelectPrimitive.Popup
                    ...
                    className={cn(
                        `
                          ...
                          bg-popover/70 text-popover-foreground shadow-lg ring-1
...
function SelectScrollUpButton({
    ...
    return (
        <SelectPrimitive.ScrollUpArrow
            ...
            className={cn(
                `
                  top-0 z-10 flex w-full cursor-default items-center
                  justify-center bg-popover py-1
                  [&_svg:not([class*='size-'])]:size-4
                `,
                className
            )}
...
function SelectScrollDownButton({
    ...
    return (
        <SelectPrimitive.ScrollDownArrow
            ...
            className={cn(
                `
                  bottom-0 z-10 flex w-full cursor-default items-center
                  justify-center bg-popover py-1
                  [&_svg:not([class*='size-'])]:size-4
                `,
                className
