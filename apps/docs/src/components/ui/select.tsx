...
import { AltArrowDownIcon, AltArrowUpIcon, CheckCircleIcon } from '@solar-icons/react/bold-duotone'
                ...
                <SelectPrimitive.Popup
                    ...
                    className={cn(
                        `
                          ...
                          overflow-y-auto rounded-3xl bg-popover/70 text-popover-foreground
...
function SelectScrollDownButton({
    ...
    return (
        <SelectPrimitive.ScrollDownArrow
            ...
            className={cn(
                `
                  bottom-0 z-10 flex w-full cursor-default items-center justify-center bg-popover
                  py-1
                  [&_svg:not([class*='size-'])]:size-4
                `,
                className
