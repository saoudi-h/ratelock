                ...
                <ComboboxPrimitive.Popup
                    ...
                    className={cn(
                        `
                          ...
                          overflow-hidden rounded-3xl bg-popover/70
                          text-popover-foreground shadow-lg ring-1
        ...
        <ComboboxPrimitive.Chips
            ...
            className={cn(
                `
                  ...
                  border-transparent bg-input/50 bg-clip-padding px-3 py-1.5
                  text-sm transition-[color,box-shadow,background-color]
                  focus-within:border-ring focus-within:ring-3
...
function ComboboxChip({
    ...
    return (
        <ComboboxPrimitive.Chip
            ...
            className={cn(
                `
                  flex h-[calc(--spacing(5.5))] w-fit items-center
                  justify-center gap-1 rounded-3xl bg-input px-2 text-xs
