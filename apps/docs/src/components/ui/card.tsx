...
function Card({
    ...
    return (
        <div
            ...
            className={cn(
                `
                  group/card flex flex-col gap-6 overflow-hidden rounded-4xl
                  bg-card py-6 text-sm text-card-foreground shadow-md ring-1
                  ring-foreground/5
        ...
        <div
            ...
            className={cn(
                `
                  ...
                  items-start gap-1.5 rounded-t-4xl px-6
