        ...
        props: mergeProps<'button'>(
            {
                className: cn(
                    `
                      absolute top-3.5 right-3 flex aspect-square w-5
                      items-center justify-center rounded-xl p-0
        ...
        <div
            ...
            className={cn(
                `
                  ...
                  items-center justify-center rounded-xl px-1 text-xs
        ...
        props: mergeProps<'a'>(
            {
                className: cn(
                    `
                      ...
                      overflow-hidden rounded-xl px-3 text-sidebar-foreground
