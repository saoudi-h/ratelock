...
import { Sidebar as SidebarIcon } from '@solar-icons/react-perf/BoldDuotone'
        ...
        props: mergeProps<'button'>(
            {
                className: cn(
                    `
                      ...
                      rounded-xl p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden
        ...
        <div
            ...
            className={cn(
                `
                  ...
                  rounded-xl px-1 text-xs font-medium text-sidebar-foreground tabular-nums
                  select-none
                  group-data-[collapsible=icon]:hidden
                  peer-hover/menu-button:text-sidebar-accent-foreground
        ...
        props: mergeProps<'a'>(
            {
                className: cn(
                    `
                      flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-xl
                      px-3 text-sidebar-foreground ring-sidebar-ring outline-hidden
                      group-data-[collapsible=icon]:hidden
                      hover:bg-sidebar-accent hover:text-sidebar-accent-foreground
                      focus-visible:ring-2
                      active:bg-sidebar-accent active:text-sidebar-accent-foreground
