...
export function DenyCacheVisualization() {
            ...
            tl.from(root, {
                ...
                .from(
                    root.querySelectorAll(
                        '[data-deny-eyebrow], [data-deny-title], [data-deny-desc]'
                    ),
                    {
                        y: 14,
                        opacity: 0,
    ...
    return (
        <div ref={ref} className="flex h-full flex-col justify-between lg:col-span-5">
            <BentoBase className="h-full gap-8">
                <div>
                    ...
                    <p data-deny-desc className="mt-2 text-xs/relaxed text-muted-foreground">
                ...
                <div
                    data-deny-diagram
                    className="
                      relative flex h-48 w-full flex-col items-center justify-center overflow-hidden
                      rounded-3xl border border-border/40 bg-muted/40 p-4 font-mono text-[10px]
                    ...
                    <div
                        ...
                        <span
                            className="text-[8px] font-bold tracking-widest text-zinc-400 uppercase">
                            Spam Client
                        </span>
                    </div>
                    ...
                    <div
                        data-deny-shield
                        className={`
                          absolute top-1/2 z-10 flex -translate-y-1/2 items-center gap-2 rounded-2xl
                          border bg-background/90 px-4 py-2 opacity-100 shadow-sm transition-colors
                          duration-300
                          ${
                              denyCacheFlooded
                    ...
                    <div
                        className="
                          pointer-events-none absolute inset-y-[36px] left-1/2 w-10 -translate-x-1/2
                          overflow-hidden
                        ">
                        <div
                            key={denyCacheFlooded ? 'shielded-flow' : 'direct-flow'}
                            className="absolute inset-0">
                            <DenyCacheParticle color="emerald" delay="0s" end="100%" offset="0px" />
                            <DenyCacheParticle
                                color="red"
                                delay="0.45s"
                ...
                <div className="space-y-2">
                    ...
                    <div
                        data-deny-stat
                        className="
                          flex items-center justify-between text-xs font-bold text-foreground
                        ">
