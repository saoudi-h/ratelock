    ...
    return (
        <div
            ...
            className={cn(
                styles.bgExplore,
                `
                  group flex flex-col items-start justify-between gap-6 rounded-4xl border
                  border-border/30 bg-muted/20 p-8 transition-colors duration-300
            ...
            <div>
                ...
                <h3
                    ref={titleRef}
                    className="mt-3 font-heading text-2xl font-bold text-foreground sm:text-3xl">
