...
export function HeroCtas({
    command = 'npm install @ratelock/local @ratelock/redis',
}: HeroCtasProps) {
    registerGsap()
        ...
        <div
            ...
            <button
                ...
                className="
                  ...
                  rounded-2xl border border-border/40 bg-muted/40 px-5
                  font-mono text-xs font-semibold text-muted-foreground shadow-xs
                  transition-all duration-200 select-none
