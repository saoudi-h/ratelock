    ...
    return (
        <div
            ...
            <button
                ...
                className="
                  group flex h-12 w-full items-center justify-between gap-3 rounded-2xl border
                  border-border/40 bg-muted/40 px-5 font-mono text-xs font-semibold
                  text-muted-foreground shadow-xs transition-all duration-200 select-none
