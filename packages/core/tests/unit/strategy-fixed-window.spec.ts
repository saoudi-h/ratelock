...
describe('TypedFixedWindowStrategy', () => {
    let storage: InMemoryStorage
    let strategy: TypedFixedWindowStrategy
    ...
    it("autorise jusqu'à limit requêtes dans la même fenêtre", async () => {
    ...
    it('décrémente si dépassement pour compenser la sur-incrémentation', async () => {
    ...
    it('utilise TTL basé sur la fin de fenêtre', async () => {
    ...
    it('validation options négatives via builder/registry: lève une erreur', () => {
        expect(() => {
