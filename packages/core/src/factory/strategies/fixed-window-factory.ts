...
import { type FixedWindowOptions, createFixedWindowStrategy } from '../../strategy/fixed-window'
 ...
 */
export function createFixedWindowLimiterFactory<TStorageConfig, T extends Storage = Storage>(
