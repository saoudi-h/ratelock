...
import { createTokenBucketLimiter } from '../../../src/factory/strategies/token-bucket-factory'
...
describe('Token Bucket Factory', () => {
    ...
    describe('createTokenBucketLimiter', () => {
        it('should create token bucket rate limiter', async () => {
            const { limiter, storage } = await createTokenBucketLimiter({
                strategy: { capacity: 10, refillRate: 1, refillTime: 60000 },
                storage: {
