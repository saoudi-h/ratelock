...
- Strategy implementations are shared with the Edge adapter through private `@ratelock/redis-common`; keep that layer transport-neutral and inject connection factories rather than importing drivers there.
