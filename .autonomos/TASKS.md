...
- [ ] **[TST-02]** Strengthen contract suites: duplicate-id batch cases (would have caught CORE-02), per-key state assertions, deny propagation; add postgres `pg` pool driver leg to integration `Priority: 🟠` `Complexity: M`
